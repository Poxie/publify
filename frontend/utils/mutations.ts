...
export const UPDATE_PROFILE = gql`
    mutation($username: String, $password: String, $currentPassword: String, $displayName: String, $bio: String, $avatar: Upload, $banner: Upload, $relationship: String, $education: String, $location: String) {
        updateProfile(username: $username, password: $password, currentPassword: $currentPassword, displayName: $displayName, bio: $bio, avatar: $avatar, banner: $banner, relationship: $relationship, education: $education, location: $location) {
            ${USER_PROPERTIES}
        }
    }
`
